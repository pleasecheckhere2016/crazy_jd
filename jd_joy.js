...
function getFood(type) {
    ...
    return new Promise(resolve => {
        ...
        const url = `https://jdjoy.jd.com/common/pet/getFood?reqSource=h5&lks=${lks}&lkt=${lkt}&taskType=ThreeMeals`;
        const host = `jdjoy.jd.com`;
        const reqSource = 'h5';
        $.get(taskUrl(url, host, reqSource), (err, resp, data) => {
            try {
...
function followShop(shopId) {
    ...
    return new Promise(resolve => {
        const url = `https://jdjoy.jd.com/common/pet/followShop?reqSource=h5&lks=${lks}&lkt=${lkt}`;
...
function getFollowShops() {
    ...
    return new Promise(resolve => {
        const url = `https://jdjoy.jd.com/common/pet/getFollowShops?reqSource=h5&lks=${lks}&lkt=${lkt}`;
        const reqSource = 'h5';
        const host = 'jdjoy.jd.com';
        $.get(taskUrl(url, host, reqSource), (err, resp, data) => {
            try {
